        ...
        <div class="card-deck">
            @foreach ($products as $product)
                <div class="card" style="width: 18rem;">
                    @if ($product->image)
                        <img class="card-img-top" src="{{ url('storage/images/'.$product->image) }}" alt="{{ $product->name }}" data-holder-rendered="true" style="height: 225px; width: 100%; display: block;">
                    @else
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <div class="font-weight-bold">Price: </div>{{ $product->price }}$
                        </p>
